/* $Id: lr33000.h,v 1.2 1996/01/16 14:17:18 chris Exp $ */
...
#ifdef SABLE
#define M_TIC1	0xa07fff00	/* timer 1 initial count */
#define M_TC1	0xa07fff04	/* timer 1 control 	 */
#define M_TIC2	0xa07fff08	/* timer 2 initial count */
#define M_TC2	0xa07fff0c	/* timer 2 control 	 */
#define M_RTIC	0xa07fff10	/* refresh timer	 */
#define M_CFGREG	0xa07fff20	/* configuration reg	 */
#else
...
#ifdef LANGUAGE_C
#define TIC1   (*((volatile unsigned long *)M_TIC1)) /* timer 1 initial count */
#define TC1    (*((volatile unsigned long *)M_TC1))  /* timer 1 control	 */
#define TIC2   (*((volatile unsigned long *)M_TIC2)) /* timer 2 initial count */
#define TC2    (*((volatile unsigned long *)M_TC2))  /* timer 2 control */
#define RTIC   (*((volatile unsigned long *)M_RTIC)) /* refresh timer */
#define CFGREG (*((volatile unsigned long *)M_CFGREG)) /* configuration reg */
#endif
