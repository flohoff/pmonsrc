...
#define N4_INTSTAT1_IL0_SHIFT	0
#define N4_INTSTAT1_IL0_MASK	(N4CONST(0xffff) << 0)
#define N4_INTSTAT0_IL0(dev)	(N4CONST(1) << ((dev)+0))
#define N4_INTSTAT1_IL1_SHIFT	16
#define N4_INTSTAT1_IL1_MASK	(N4CONST(0xffff) << 16)
#define N4_INTSTAT0_IL1(dev)	(N4CONST(1) << ((dev)+16))
#define N4_INTSTAT1_IL2_SHIFT	32
#define N4_INTSTAT1_IL2_MASK	(N4CONST(0xffff) << 32)
#define N4_INTSTAT0_IL2(dev)	(N4CONST(1) << ((dev)+32))
#define N4_INTSTAT1_IL3_SHIFT	48
#define N4_INTSTAT1_IL3_MASK	(N4CONST(0xffff) << 48)
