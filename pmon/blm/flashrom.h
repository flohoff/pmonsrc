...
#ifndef FROM_NEVER_INTEL
#define FROMFLG_SPROT		0x0100	/* sharp "sector protect" available */
#else
...
#define TYPE_s008C	FROMFLG_BIWIDE|FROMFLG_IBCS|FROMFLG_PROT
#define TYPE_s016U	FROMFLG_BIWIDE|FROMFLG_IBCS|FROMFLG_SPROT
