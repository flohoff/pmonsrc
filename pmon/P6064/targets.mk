## $Id: targets.mk,v 1.1 2001/08/12 14:28:43 chris Exp $
#
# Targets.mk for PMON on Algorithmics P6064 board
#
...
# Machine type(s)
MACHINE =$(CPUFLGS) -DP6064 -DMHZ=120 -DTLBREGISTERS -DFLASH -DRTC -DINET -DBOOTPKG
