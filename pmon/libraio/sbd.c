/* $Id: sbd.c,v 1.3 1999/04/22 16:35:34 chris Exp $ */
/*
 *	
...
/* max cycle time ?? */
#define DEVTIME0	IOCONFIG_MAX_TIME
#define DEVTIME1	IOCONFIG_MAX_TIME

/* ??? */
#define DEVTIME3	IOCONFIG_MAX_TIME
#define DEVTIME4	IOCONFIG_MAX_TIME
...
const struct vrent sbditab[] = {
  ...
  {REGP(G10_PIOCONFIG),	G10_PIO_UARTINT1 | G10_PIO_UARTINT0},
...
{
    {(Addr)Z8530_CHANA, 0, z8530, 256, B9600},
    {(Addr)Z8530_CHANB, 1, z8530, 256, B9600},
