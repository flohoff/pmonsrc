/*
 * GAL9/sbdfrom.c: Flash ROM support for Galileo GAL9
...
static struct mandevinfo {
    ...
    /* 4Mb = 512KB devices  */
    {"Am29F400T",
     MAN_AMD,		0x23,	0x080000*4, FBTOP, 0x10000*4},
    {"Am29F400B",
     MAN_AMD, 		0xab,	0x080000*4, FBBOT, 0x10000*4},
    {"Fujitsu 29F400-T",
     MAN_FUJITSU,	0x23,	0x080000*4, FBTOP, 0x10000*4},
    {"Fujitsu 29F400-B",
     MAN_FUJITSU,	0xab,	0x080000*4, FBBOT, 0x10000*4},
    {"Micron MT28LF400T",
     MAN_MICRON,	0x30,	0x080000*4, FBTOP, 0x10000*4},
    {"Micron MT28LF400B",
     MAN_MICRON,	0x31,	0x080000*4, FBBOT, 0x10000*4},
    {"Intel 28F400-T",
     MAN_INTEL,		0x70,	0x080000*4, FBTOP, 0x10000*4},
    {"Intel 28F400-B",
     MAN_INTEL,		0x71,	0x080000*4, FBBOT, 0x10000*4},
    {0}
};


/* We always program in multiples of an 8-byte line, since this is
   much faster (we can program all 4 devices in parallel */
#define LINESIZE	8
...
static struct flashcookie cookies[NFLASHDEVS] = {
    {BOOTPROM_BASE,	0x080000*4,	LINESIZE,	&flashdev},
    {FLASH_BASE, 	0x080000*4,	LINESIZE,	&flashdev},
};

#ifndef IN_PMON
/* general purpose sector buffer */
...
{
    static const int bootsecs[] = {0x4000*4, 0x2000*4, 0x2000*4, 0};
