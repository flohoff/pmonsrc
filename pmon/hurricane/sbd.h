 ...
 *
 * a04 19/jan/1999 rh  4:30p -change INTR_DEV_V96X to INTR_DEV_V3USC
 * a03 16/sep/1998 rh  4:30p -change address of FLASH_BASE,FLASH_BASE1.
 * a02 08/sep/1998 rh  4:30p -added #define V320USC, V3USC_BASE.
 * a01 26/aug/1998 rh	-changed address to reflect that used on Hurrican board
 */
...
#define	V3USC_BASE		0x1d000000	/*      : V320USC		   */

#define COMBI_BASE		0x1e100000	/*   1MB: UART0, channel A */
#define COMBI_BASE1		0x1e200000	/*   1MB: UART1, channel B */
#define PARAL_BASE		0x1e300000	/*   32B: Parallel port    */
#define LED_BASE		0x1e300020	/*    1B: LED (8)		   */
#define SWITCH_BASE		0x1e300040	/*    1B: SWITCH		   */
#define FLASH_BASE		0x1e800000	/*   2MB: USER FLASH-1 (U )*/
#define FLASH_BASE1		0x1ea00000	/*   2MB: USER FLASH-2 (U9)*/

#define PCI_IO_SPACE	0x1ed00000	/*   1MB: s/w configurable */
#define PCI_CONF_SPACE	0x1c000000	/*  16MB: s/w configurable */
...
#define UART0_BASE	ioaddrb(COMBI_BASE, 0)
#define UART1_BASE	ioaddrb(COMBI_BASE1, 0)
