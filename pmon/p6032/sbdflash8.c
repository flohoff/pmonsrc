/*
 * p6032/sbdflash8.c: 8 bit flash ROM support for P-6032
 *
...
int
_flash8_probe (struct fromcookie *fcp, unsigned int o)
{
    return _flashrom_probe (fcp, o);
}

/* include code inline since sbdflash16.c will need a different copy */
#include "flashrom.c"
