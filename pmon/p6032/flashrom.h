...
#define FROM_FAMILY_AMD		(FROM_FAMILY_ATMEL)
#endif
#ifndef FROM_FAMILY_INTEL
#define FROM_FAMILY_INTEL 	0
#endif

#if (FROM_FAMILY_AMD+FROM_FAMILY_ATMEL+FROM_FAMILY_INTEL)==0
...
#define FROMFLG_AM29DL		0x0080	/* AMD 29DL asymmetric banks */
...
#define FROMFLG_NOSECTERASE	0x0400	/* Sector erase not supported */
#define FROMFLG_AUTOEX		0x0800	/* Extended autoselect */
...
#define TYPE_LV600	(TYPE_aF400|FROMFLG_BPASS|FROMFLG_AUTOEX)
...
#define TYPE_sF160	(TYPE_iF400|FROMFLG_AM29DL)
...
struct fromdevinfo {
    ...
    unsigned int	xid;			/* extended autoselect ID */
};
...
struct fromcookie {
    ...
    unsigned long		virtoffs;	/* offs from dev base */
