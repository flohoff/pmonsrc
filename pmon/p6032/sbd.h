...
#define PIO_CPLDARB	BONITO_GPIO_IOW(4)	/* P6032: CPLD arbiter */
#define PIO_REGENABLE	BONITO_GPIO_IOW(4)	/* P6064: Registered DIMM enable */
...
#define PM_PORT		0xe000	/* FIXME: where should this go? */
#define GPIO_PORT	0xe100	/* FIXME: where should this go? */
...
/* Low level code stores the memory size here... */
#define MEMSIZE		PA_TO_KVA1(0x180-4)
