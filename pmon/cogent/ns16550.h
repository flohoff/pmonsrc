/* $Id: ns16550.h,v 1.2 1996/01/16 14:24:35 chris Exp $ */
/*
 * NS16550 UART registers
 */

#define NS16550_CHANA	PHYS_TO_K1(IOCHAN0_BASE)
#define NS16550_CHANB	PHYS_TO_K1(IOCHAN1_BASE)

#ifdef MIPSEB
#define nsreg(x)	unsigned :32; unsigned :24; unsigned x:8
#endif
#ifdef MIPSEL
#define nsreg(x)	unsigned x:8; unsigned :24; unsigned :32
#endif
