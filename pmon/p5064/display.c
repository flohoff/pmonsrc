/*
 * p5064/display.c: low-level routines to talk to the LCD front panel display
 */
...
led_flash (int on)
{
    volatile struct p5064bcr0 * const bcr0 = PA_TO_KVA1 (BCR0_BASE);
    bcr0->led = on ? BCR0_LED_ON : BCR0_LED_OFF;
}
