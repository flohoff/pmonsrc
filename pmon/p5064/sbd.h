...
#define GPIO_PORT	0xff00	/* FIXME: where should this go? */
...
#define BCR0(x)		PA_TO_KVA1 (BCR0_BASE + (x))
...
#define BOARD_REVISION ((((*(unsigned int *)PA_TO_KVA1(OPTION_BASE)) & OPTION_REV) >> OPTION_REV_SHIFT) + 'A')
